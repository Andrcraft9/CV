...
\cventry{2016-2019}{R\&D intern}{{Schlumberger}}{}{}
{
\begin{itemize}
...
\cvcomputer{Programming Languages}{C++ (98/11/17), C, Fortran, Python, Wolfram Mathematica}{Parallel Computing}{Threads, MPI, OpenMP, CUDA}
\cvcomputer{Development tools}{git, bash, gdb, valgring, vim, VS, ect.}{Build systems}{CMake, Ninja, Jenkins}
\cvcomputer{Computer Graphics}{OpenSceneGraph, OpenGL, GSL}{Libraries}{STL, Qt, PETSc, OpenFoam, Lapack, BLAS, etc.}
\cvline{General}{\LaTeX, OOP, test driven development, agile methodology, etc.}
